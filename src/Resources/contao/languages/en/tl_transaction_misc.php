...
$GLOBALS['TL_LANG']['tl_transaction_misc']['status']                    = array('Status', 'Tracks the current Status of this Transaction. Status is updated throughout the generation process at each step of the process');
