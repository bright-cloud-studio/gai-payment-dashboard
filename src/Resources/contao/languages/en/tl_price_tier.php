...
$GLOBALS['TL_LANG']['tl_price_tier']['alias']                      = array('Alias', 'Auto-generated alias.');
$GLOBALS['TL_LANG']['tl_price_tier']['published']                  = array('Published', 'Show this record on the front end.');
