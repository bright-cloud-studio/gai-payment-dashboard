...
$GLOBALS['TL_LANG']['MOD']['gai_emails'][0] = "Automated Emails";
$GLOBALS['BE_MOD']['gai_emails']['alert_email'] = array( 'tables' => array('tl_alert_email') );
$GLOBALS['BE_MOD']['gai_emails']['email_record'] = array( 'tables' => array('tl_email_record') );
