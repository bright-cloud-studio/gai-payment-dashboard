...
(
    ...
    (
        ...
        'billing_month' => array
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_school']['billing_month'],
            'inputType'               => 'text',
            'default'                 => '',
            'search'                  => true,
        ...
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_school']['date_submitted'],
            'inputType'               => 'text',
            'default'                 => '',
            'search'                  => true,
            'eval'                    => array('mandatory'=>true, 'tl_class'=>'w50'),
        ...
        'psychologist' => array
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_school']['psychologist'],
            'inputType'               => 'text',
            'default'                 => '',
            'search'                  => true,
            'eval'                    => array('mandatory'=>true, 'tl_class'=>'w50'),
        ...
        'district' => array
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_school']['district'],
            'inputType'               => 'text',
            'default'                 => '',
            'search'                  => true,
            'eval'                    => array('mandatory'=>true, 'tl_class'=>'w50'),
        ...
        'school' => array
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_school']['school'],
            'inputType'               => 'text',
            'default'                 => '',
            'search'                  => true,
            'eval'                    => array('mandatory'=>true, 'tl_class'=>'w50'),
        ...
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_school']['student_initials'],
            'inputType'               => 'text',
            'default'                 => '',
            'search'                  => true,
            'eval'                    => array('mandatory'=>true, 'tl_class'=>'w50'),
        ...
        'service_code' => array
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_school']['service_code'],
            'inputType'               => 'text',
            'default'                 => '',
            'search'                  => true,
            'eval'                    => array('mandatory'=>true, 'tl_class'=>'w50'),
        ...
        'price' => array
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_school']['price'],
            'inputType'               => 'text',
            'default'                 => '',
            'search'                  => true,
            'eval'                    => array('mandatory'=>true, 'tl_class'=>'w50'),
        ...
        'lasid' => array
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_school']['lasid'],
            'inputType'               => 'text',
            'default'                 => '',
            'search'                  => true,
        ...
        'sasid' => array
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_school']['sasid'],
            'inputType'               => 'text',
            'default'                 => '',
            'search'                  => true,
            'eval'                    => array('mandatory'=>false, 'tl_class'=>'w50'),
        ...
        'meeting_date' => array
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_school']['meeting_date'],
            'inputType'               => 'text',
            'default'                 => '',
            'search'                  => true,
            'eval'                    => array('mandatory'=>false, 'tl_class'=>'w50'),
        ...
        'meeting_start' => array
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_school']['meeting_start'],
            'inputType'               => 'text',
            'default'                 => '',
            'search'                  => true,
            'eval'                    => array('mandatory'=>false, 'tl_class'=>'w50'),
        ...
        'meeting_end' => array
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_school']['meeting_end'],
            'inputType'               => 'text',
            'default'                 => '',
            'search'                  => true,
            'eval'                    => array('mandatory'=>false, 'tl_class'=>'w50'),
        ...
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_school']['meeting_duration'],
            'inputType'               => 'text',
            'default'                 => '',
            'search'                  => true,
            'eval'                    => array('mandatory'=>false, 'tl_class'=>'w50'),
        ...
        'notes' => array
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_school']['notes'],
            'inputType'               => 'text',
            'default'                 => '',
            'search'                  => true,
            'eval'                    => array('mandatory'=>false, 'tl_class'=>'w50'),
        ...
        'reviewed' => array
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_school']['reviewed'],
            'inputType'               => 'text',
            'default'                 => '',
            'search'                  => true,
            'eval'                    => array('mandatory'=>false, 'tl_class'=>'w50'),
        ...
        'deleted' => array
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_school']['deleted'],
            'inputType'               => 'text',
            'default'                 => '',
            'search'                  => true,
            'eval'                    => array('mandatory'=>false, 'tl_class'=>'w50'),
        ...
        'misc_billing' => array
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_school']['misc_billing'],
            'inputType'               => 'text',
            'default'                 => '',
            'search'                  => true,
            'eval'                    => array('mandatory'=>false, 'tl_class'=>'w50'),
        ...
        'assignment_id' => array
        (
            'label'                   => &$GLOBALS['TL_LANG']['tl_school']['assignment_id'],
            'inputType'               => 'text',
            'default'                 => '',
            'search'                  => true,
            'eval'                    => array('mandatory'=>false, 'tl_class'=>'w50'),
