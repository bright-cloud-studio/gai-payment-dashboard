...
(
    ...
    (
        ...
        (
            ...
            (
              ...
              'icon'                => 'visible.gif',
              'attributes'          => 'onclick="if(!confirm(\'' . ($GLOBALS['TL_LANG']['MSC']['confirmToggle'] ?? 'Please confirm you would like to toggle this Student on/off') . '\')) return false; Backend.getScrollOffset()"',
    ...
    (
        ...
        (
            ...
            'filter'                  => true,
            'search'                  => true,
            'options'                  => array('male' => 'Male', 'female' => 'Female', 'nonbinary' => 'Nonbinary', 'other' => 'Other', 'not_specified' => 'Not Specified'),
            'eval'                     => array('mandatory'=>false, 'tl_class'=>'w50', 'includeBlankOption'=>true, 'blankOptionLabel'=>'Select a Gender'),
